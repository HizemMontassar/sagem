...
<html>
    ...
    <body>
        <div>
            ...
            <form action="../home_db.php" method="POST" enctype="multipart/form-data">
                <fieldset>
                <legend>Demande Rayon-X :</legend>
                <table>
                    <tr>
                        <td>UF/Service</td>
                        <td>
                    ...
                    <tr>
                        <td>Ref CIU</td>
                        <td><input type="text" name="ref" placeholder="reference"></td>
                    </tr>
                    <tr>
                        <td>S/N</td>
                        <td><input type="text" name="sn" placeholder="S/N"></td>
                    </tr>
                    <tr>
                        <td>Nbr de cartes</td>
